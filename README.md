...
We have used Databricks as the deployment destination but you are not bound to do that. By chaning the deployemnt step of CICD workflow you can deply the wheel package on data platform/cloud/repository of your choice.
